...
@section('content')
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="" class="text-danger" data-bs-toggle="modal" data-bs-target="#employeeDeleteModal">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="modal fade" id="employeeDeleteModal" tabindex="-1" aria-labelledby="labelDeleteModal" aria-hidden="true">
